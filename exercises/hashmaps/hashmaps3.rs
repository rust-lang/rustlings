...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        // team_1.
        // scores.entry(String::from(&team_1_name)).or_insert(Team{name: String::from(&team_1_name), goals_scored: team_1_score, goals_conceded: team_2_score});
        // scores.entry(String::from(&team_2_name)).or_insert(Team{name : String::from(&team_2_name), goals_scored: team_2_score, goals_conceded: team_1_score});
